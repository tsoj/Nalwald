...
const fens = [
  # classical positions
  "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w QKqk - 0 1",
  "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1",
  "r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w qk - 0 ",
  ...
  "nrnqkrbb/pppp1ppp/4p3/8/6P1/1N6/PPPPPP1P/1RNQKRBB b Kqk - 1 2",
...
for fen in fens:
  ...
  for depth in 1.Ply .. Ply.high:
    ...
    stdout.flushFile
    let nodesCurrent =
      execProcess(benchTestBinaryFile(currentBranch) & fmt" {depth} {fen}")
