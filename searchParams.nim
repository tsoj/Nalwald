...
addParam(deltaMargin, default = 100, min = 30, max = 300, step = 15)
addParam(failHighDeltaMargin, default = 50, min = 10, max = 200, step = 10)
addParam(aspirationWindowStartingOffset, default = 10, min = 2, max = 100, step = 2)
...
addParam(nullMoveDepthDiv, default = 4, min = 1, max = 15, step = 1)
addParam(lmrDepthHalfLife, default = 30, min = 5, max = 60, step = 5)
addParam(lmrDepthSub, default = 1.Ply, min = 0.Ply, max = 5.Ply, step = 1.Ply)
addParam(iirMinDepth, default = 6.Ply, min = 0.Ply, max = 12.Ply, step = 1.Ply)
